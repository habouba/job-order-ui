/**
 * Joborders-oriented InMemoryDbService with method overrides.
 */
...
/**
 * Remap a known singular collection name ("joborder")
 * to the plural collection name ("joborders"); else return the name
